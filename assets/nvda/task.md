...
- The first regression prototype was informative but not persuasive enough to replace the current binary combo, so NVDA should stay on the binary-watchlist path for now.
