...
ASSET_KEY = "gld"
LABEL_MODE = "future-return-top-bottom-20pct"
LEFT_EXPERT = "dual_context_above200"
RIGHT_EXPERT = "combo"
OUTER_GATE_FEATURE = "rolling_vol_60"
OUTER_GATE_THRESHOLD = 0.0087
...
def main() -> None:
    ...
    output_path = Path(ac.get_cache_dir(ASSET_KEY)) / "gld_topbottom20_hard_gate_two_expert.json"
